...
- Both named and unnamed completed runs can be continued by their run ID while they remain available. Named runs remain continuable by name until their lease expires.
- When the lease expires, successful named runs leave the normal status/widget surfaces and can no longer be continued.
