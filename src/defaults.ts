...
// RUN_NAME_PATTERN is linear-time safe: bounded, non-overlapping quantifiers only.
// Quantifier upper bound is MAX_RUN_NAME_LENGTH - 1 (= 63) because the first character is mandatory.
